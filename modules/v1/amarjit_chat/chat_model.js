...
var chat_model = {
    ...
    cheakMessage: (request, callback) => {
        ...
        var sql = `SELECT * FROM tbl_chat_room cr WHERE (cr.sender_id = '${request.sender_id}' AND cr.reciver_id = '${request.receiver_id}' AND event_id = '${request.event_id}') OR (cr.reciver_id = '${request.sender_id}'  AND cr.sender_id = '${request.receiver_id}' AND event_id = '${request.event_id}')`;
